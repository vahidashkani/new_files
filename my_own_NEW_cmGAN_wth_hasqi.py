...
# -*- coding: utf-8 -*-
"""
Created on Tue Nov 28 10:57:55 2023
...
class DilatedDenseNet(nn.Module):
    def __init__(self, ndf=8, in_channels=64):
        super(DilatedDenseNet, self).__init__()
        self.in_channels = in_channels
...
class DenseEncoder(nn.Module):
    def __init__(self, in_channel, channels=64):
        ...
        self.dilated_dense = DilatedDenseNet(ndf=8, in_channels=64)
...
class MaskDecoder(nn.Module):
    def __init__(self, num_features, num_channel=64, out_channel=1):
        ...
        self.dense_block = DilatedDenseNet(ndf=8, in_channels=64)
